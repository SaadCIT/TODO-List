...
import com.example.todolist.databinding.FragmentSingInBinding
import com.google.firebase.auth.FirebaseAuth

class Sing_inFragment : Fragment() {
    ...
    private fun singInuser(email: String, password: String, user: String) {
        ...
        auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener{task->
            if (task.isSuccessful){
                ...
                findNavController().navigate(R.id.action_sing_inFragment_to_homeFragment)
            }else{
